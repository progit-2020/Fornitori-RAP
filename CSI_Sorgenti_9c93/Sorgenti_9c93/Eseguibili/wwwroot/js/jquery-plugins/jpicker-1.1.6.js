...
(function($, version)
{
    ...
    function(options)
    {
      ...
      return this.each(
        function()
        {
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            commitColor = // commit the color changes
              function()
              {
                ...
                //Massimo: in questo modo viene agganciato l'evento IW
                $(this).change();
              },
            radioClicked =
              function(e)
            ...
            show =
              function()
              {
                ...
                if (settings.window.expandable)
                {
                  $(document.body).children('div.jPicker.Container').css({zIndex:910});
                  container.css({zIndex:920});
                }
            ...
            hide =
              function()
              {
                var removeIFrame = function()
                  {
                    if (settings.window.expandable) container.css({ zIndex: 910 });
                    if (!settings.window.expandable || $.support.boxModel) return;
          ...
          var isPresent = false;
          for (i = 0; i < List.length; i++) if (List[i] == $this) isPresent=true;
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '/img/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          text:
          {
            ...
            title: 'Sposta il puntatore per selezionare un colore',
            //newColor: 'new',
            newColor: 'nuovo',
