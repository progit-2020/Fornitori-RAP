...
//------- Congedi partentali COVID-19
    QRDBText13.DataField := 'NDipURagg13';
    QRDBText14.DataField := 'NGioURagg13';
    QRDBText15.DataField := 'NDipDRagg13';
    QRDBText16.DataField := 'NGioDRagg13';
//------- Sciopero
...
//------- Congedi partentali COVID-19
    QRDBText13.DataSet:=A045FDialogStampa.A045MW.TabellaStampa;
    QRDBText14.DataSet:=A045FDialogStampa.A045MW.TabellaStampa;
    QRDBText15.DataSet:=A045FDialogStampa.A045MW.TabellaStampa;
    QRDBText16.DataSet:=A045FDialogStampa.A045MW.TabellaStampa;
//------- Sciopero
...
begin
  ...
  begin
    ...
    begin
      ...
      TotM2.Caption:=FloatToStr(StrToFloatDef(TotM2.Caption,0) + TabellaStampa.FieldByName('NGioURagg13').AsFloat);
      TotM4.Caption:=FloatToStr(StrToFloatDef(TotM4.Caption,0) + TabellaStampa.FieldByName('NGioDRagg13').AsFloat);
    ...
    begin
      ...
      if selT043TotRaggr.FieldByName('COD_CODICIACCORPAMENTOASS').AsString = 'M' then
      begin
        if selT043TotRaggr.FieldByName('SESSO').AsString = 'M' then
        begin
          TotM1.Caption := selT043TotRaggr.FieldByName('NDIP').AsString;
          TotM2.Caption := Format('%-.2f',[StrToFloatDef(TotM2.Caption,0)]);
        end
        else
        begin
          TotM3.Caption := selT043TotRaggr.FieldByName('NDIP').AsString;
          TotM4.Caption := Format('%-.2f',[StrToFloatDef(TotM4.Caption,0)]);
        end;
      end;
    ...
    begin
      ...
      begin
        ...
        GGGenM.Caption:=FloatToStr(StrToFloatDef(TotA2.Caption,0) + StrToFloatDef(TotC2.Caption,0) + StrToFloatDef(TotI2.Caption,0) +
                        ...
                        StrToFloatDef(TotB2.Caption,0) + StrtoFloatDef(TotM2.Caption,0) + StrtoFloatDef(TotD2.Caption,0) +
      ...
      begin
        ...
        GGGenF.Caption:=FloatToStr(StrToFloatDef(TotA4.Caption,0) + StrToFloatDef(TotC4.Caption,0) + StrToFloatDef(TotI4.Caption,0) +
                        ...
                        StrToFloatDef(TotB4.Caption,0) + StrtoFloatDef(TotM4.Caption,0) + StrtoFloatDef(TotD4.Caption,0) +
