...
type
  TA176FRiepilogoIterAutorizzativi = class(TR001FGestTab)
    ...
    procedure frmInputPeriodoRichiestaedtInizioExit(Sender: TObject);
    procedure frmInputPeriodoRichiestaedtFineExit(Sender: TObject);
...
begin
  ...
  cmbTipoIter.ItemIndex:=0;//cmbTipoIter.ItemIndex:=cmbTipoIter.Items.IndexOf('Giustificativi');
end;
...
procedure TA176FRiepilogoIterAutorizzativi.frmInputPeriodoRichiestaedtFineExit(Sender: TObject);
begin
  inherited;
  ApplicaPeriodo;
end;

procedure TA176FRiepilogoIterAutorizzativi.frmInputPeriodoRichiestaedtInizioExit(Sender: TObject);
begin
  inherited;
