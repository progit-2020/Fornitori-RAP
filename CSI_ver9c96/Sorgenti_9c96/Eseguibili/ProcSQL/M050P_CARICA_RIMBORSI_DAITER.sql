create or replace procedure M050P_CARICA_RIMBORSI_DAITER(pID in integer) as
  ...
  cursor c3 is
    select M040.ID_MISSIONE, M040.PROGRESSIVO, M040.MESESCARICO, M040.MESECOMPETENZA, M040.DATADA, M040.ORADA, M020.TIPO_QUANTITA, M020.FLAG_NON_RIMBORSABILE, 
    ...
    and    M150.STATO = 'S'
    group by M040.ID_MISSIONE, M040.PROGRESSIVO, M040.MESESCARICO, M040.MESECOMPETENZA, M040.DATADA, M040.ORADA, M020.TIPO_QUANTITA, M020.FLAG_NON_RIMBORSABILE, M150.CODICE;
...
begin
    ...
    if wCOUNT_A = 0 then
      ...
      values
        (t3.ID_MISSIONE, t3.PROGRESSIVO, t3.MESESCARICO, t3.MESECOMPETENZA, t3.DATADA, t3.ORADA,
         t3.CODICE, t3.COD_VALUTA, decode(t3.TIPO_QUANTITA,'F',0,decode(t3.FLAG_NON_RIMBORSABILE,'S',0,t3.RIMBORSO)), t3.RIMBORSO);
    else
  ...
  if wRIMB_DETT = 'S' then
    ...
    where  SOMMA = 'S';
    -- estrae il primo codice tipo pagamento con somma 'N'
    select min(CODICE)
    into   wTIPO_NO_RIMBORSO
    from   M049_TIPOPAGAMENTO
    where  SOMMA = 'N';
    ...
    insert into M051_DETTAGLIORIMBORSO (PROGRESSIVO, MESESCARICO, MESECOMPETENZA, DATADA, ORADA,
      ...
      select M040.PROGRESSIVO, M040.MESESCARICO, M040.MESECOMPETENZA, M040.DATADA, M040.ORADA,
             ...
             nvl(M150.RIMBORSO_VARIATO,M150.RIMBORSO), decode(M020.FLAG_NON_RIMBORSABILE,'S',wTIPO_NO_RIMBORSO,wTIPO_RIMBORSO), null
