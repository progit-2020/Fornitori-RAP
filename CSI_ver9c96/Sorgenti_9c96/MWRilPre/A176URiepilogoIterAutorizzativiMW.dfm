inherited A176FRiepilogoIterAutorizzativiMW: TA176FRiepilogoIterAutorizzativiMW
  ...
  object selVT105: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT105.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object selVM140: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VM140.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object selVT065: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT065.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object selVT860: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT860.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object selVT085: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT085.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object selVT251: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT251.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object selVT325_EU: TOracleDataSet
    SQL.Strings = (
        ...
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT325.PROGRESSIVO) ' +
        'EMAIL'
  ...
  object T850P_MAIL_ANNULLAMENTO: TOracleQuery
    SQL.Strings = (
      'begin'
      '  T850P_MAIL_ANNULLAMENTO(:ID, :OPERAZIONE);'
      'end;')
    Optimize = False
    Variables.Data = {
      0400000002000000060000003A00490044000300000000000000000000001600
      00003A004F0050004500520041005A0049004F004E0045000500000000000000
      00000000}
    Left = 288
    Top = 224
  end
  ...
  object selVT755: TOracleDataSet
    SQL.Strings = (
      
        'select VT755.*, decode(T853F_NUMALLEGATI(VT755.T850ID),0,'#39'N'#39','#39'S'#39 +
        ') T853FILE_ALLEGATO,'
      
        '       I060F_EMAIL(I090F_GETAZIENDACORRENTE, VT755.PROGRESSIVO) ' +
        'EMAIL'
      '  from VT755_ITER_RICHIESTERENDICONTO VT755'
      ' where 1 = 1'
      '       :FILTRO'
      ' order by VT755.T850ID desc')
    Optimize = False
    Variables.Data = {
      04000000010000000E0000003A00460049004C00540052004F00010000000000
      000000000000}
    ...
    Left = 223
    Top = 16
    object selVT755T850ITER: TStringField
      FieldName = 'T850ITER'
      Required = True
      Visible = False
      Size = 10
    end
    object selVT755PROGRESSIVO: TIntegerField
      FieldName = 'PROGRESSIVO'
      Visible = False
    end
    object selVT755T850RICHIEDENTE: TStringField
      DisplayLabel = 'Richiedente'
      DisplayWidth = 20
      FieldName = 'T850RICHIEDENTE'
      Size = 30
    end
    object selVT755EMAIL: TStringField
      DisplayLabel = 'e-mail'
      DisplayWidth = 20
      FieldName = 'EMAIL'
      Size = 200
    end
    object selVT755T850DATA: TDateTimeField
      DisplayLabel = 'Data richiesta'
      FieldName = 'T850DATA'
    end
    object selVT755T755DATA: TDateField
      DisplayLabel = 'Data'
      FieldName = 'T755DATA'
    end
    object selVT755T755ORE: TStringField
      DisplayLabel = 'Ore'
      FieldName = 'T755ORE'
      Size = 10
    end
    object selVT755T850STATO: TStringField
      DisplayLabel = 'Autorizzato'
      FieldName = 'T850STATO'
      Size = 1
    end
    object selVT755T850NOTE: TStringField
      DisplayLabel = 'Note'
      DisplayWidth = 20
      FieldName = 'T850NOTE'
      Size = 2000
    end
    object selVT755T850AUTORIZZ_AUTOMATICA: TStringField
      DisplayLabel = 'Autorizz. autom.'
      FieldName = 'T850AUTORIZZ_AUTOMATICA'
      Size = 1
    end
    object selVT755T853FILE_ALLEGATO: TStringField
      DisplayLabel = 'Allegato'
      FieldName = 'T853FILE_ALLEGATO'
      Size = 1
    end
    object selVT755T850CONDIZ_ALLEGATI: TStringField
      DisplayLabel = 'Condiz. allegati'
      FieldName = 'T850CONDIZ_ALLEGATI'
      Size = 1
    end
    object selVT755T850COD_ITER: TStringField
      DisplayLabel = 'Struttura'
      DisplayWidth = 15
      FieldName = 'T850COD_ITER'
    end
    object selVT755T850ID: TFloatField
      DisplayLabel = 'ID'
      FieldName = 'T850ID'
      Required = True
    end
    object selVT755T850TIPO_RICHIESTA: TStringField
      DisplayLabel = 'Tipo rich.'
      FieldName = 'T850TIPO_RICHIESTA'
      Size = 1
    end
    object selVT755T850ID_REVOCA: TFloatField
      DisplayLabel = 'ID revoca'
      FieldName = 'T850ID_REVOCA'
      Visible = False
    end
    object selVT755T850ID_REVOCATO: TFloatField
      DisplayLabel = 'ID revocato'
      FieldName = 'T850ID_REVOCATO'
      Visible = False
    end
