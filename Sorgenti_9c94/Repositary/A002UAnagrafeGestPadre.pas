...
uses
  ...
  A002UInterfacciaSt,A005UTabelle,A011UComuniProvinceRegioni,A115UDatiLiberiStoricizzati,
      ...
      for NDL:=1 to High(DatiLiberi) do
        ...
        begin
          ...
          begin
            ...
            begin
              OpenA115DatiLiberiStoricizzati((PopupMenu1.PopupComponent as TDBLookupComboBox).Field.FieldName,(PopupMenu1.PopupComponent as TDBLookupComboBox).Text);
            ...
            begin
              OpenA005Tabelle((PopupMenu1.PopupComponent as TDBLookupComboBox).Field.FieldName,(PopupMenu1.PopupComponent as TDBLookupComboBox).Text);
            end;
          end;
        end
        else
