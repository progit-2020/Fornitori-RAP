object R600DtM1: TR600DtM1
  ...
  object selT040DataNas: TOracleDataSet
    SQL.Strings = (
      ...
      'and    ((SG101.CAUSALI_ABILITATE = '#39'*'#39') or '
      
        '        (INTERSEZ_LISTE(SG101.CAUSALI_ABILITATE, T265B.CODCAU1||' +
        #39','#39'||T265F_GETCATENACOMPLETA(:CAUSALE,'#39'T'#39')) is not null))')
    ReadBuffer = 5
    Optimize = False
    Variables.Data = {
      0400000004000000180000003A00500052004F00470052004500530053004900
