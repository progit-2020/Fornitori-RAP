...
begin
  ...
  *)
  ...
  begin
    app:=0;
    app2:=salcompannoattNetto - IfThen(BancaOreEsclusaSaldi = 'S',liquidabmese);
    if (TipoLimiteCompP = 'S') and (app2 + salcompannoprec > LimiteCompA) then
      app:=app2 + salcompannoprec;
    if (TipoLimiteCompP = 'N') and (app2 > LimiteCompA) then
      app:=app2;
    ...
    if (BancaOreEsclusaSaldi <> 'S') and ((Max(0,app - LimiteCompA) - app1) > 0) then
