...
PRE_ALLINEA_PERIODI_STORICI (sCAMPI_NOT_NULL            IN OUT VARCHAR2,     -- contiene l'elenco dei valori di default dei campi not null
...
BEGIN
  ...
  FOR RI500 IN CI500 LOOP
    ...
    ESPRESSIONE:='SELECT DISTINCT DECORRENZA FROM I501'||RI500.NOMECAMPO||' ORDER BY DECORRENZA';
