  ...
  object insT850: TOracleQuery
    SQL.Strings = (
      ...
      '    insert into T850_ITER_RICHIESTE'
        ...
        'TE,AUTORIZZ_AUTOMATICA,ID_REVOCA,ID_REVOCATO)'
      '    values '
      
        '      (:ITER,:COD_ITER,:ID,:DATA,:NOTE,:STATO,:TIPO_RICHIESTA,:R' +
        'ICHIEDENTE,:AUTORIZZ_AUTOMATICA,:ID_REVOCA,:ID_REVOCATO);'
      '  else'
    ...
    Optimize = False
    Variables.Data = {
      040000000B0000000A0000003A00490054004500520005000000000000000000
