object A092FStampa: TA092FStampa
  Left = 95
  Top = 56
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Stampa storico'
  ClientHeight = 606
  ClientWidth = 854
  Color = clBtnFace
  ...
  object RepR: TQuickRep
    ...
    DataSet = A092FStampaStoricoDtM1.TabellaStampa
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Arial'
    ...
    PrintIfEmpty = False
    ReportTitle = 'Stampa Dati Storici'
    SnapToGrid = True
    Units = MM
    Zoom = 100
