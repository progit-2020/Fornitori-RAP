  ...
  object PageControl1: TPageControl [6]
    ...
    object tabMaturazione: TTabSheet
      ...
      object Label20: TLabel
        ...
        Width = 120
        Height = 13
        Caption = 'Giorni fissi della settimana'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object lblAssenzeTollPerc: TLabel
        Left = 214
        Top = 89
        Width = 197
        Height = 13
        Caption = 'Causali di assenza tollerate in percentuale'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object lblAssenzeDiminuzioneIncluse: TLabel
        Left = 3
        Top = 126
        Width = 301
        Height = 13
        Caption = 
          'Causali di assenza tollerate che non rendono le ore sul cartelli' +
          'no'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
      ...
      object lblOrariInibiti: TLabel
        Left = 424
        Top = 126
        Width = 198
        Height = 13
        Caption = 'Orari che inibiscono maturazione/acquisto'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object GroupBox2: TGroupBox
        ...
        object lblOreMinimeSecondoBuono: TLabel
          Left = 238
          Top = 14
          Width = 35
          Height = 13
        ...
        object dchkFasceMatPomPMT: TDBCheckBox
          Tag = 1
          Left = 186
          Top = 59
          Width = 144
        ...
        object dedtOreMinimeSecondoBuono: TDBEdit
          Left = 238
          Top = 30
          Width = 40
          Height = 21
          DataField = 'OREMINIME_SECONDOBUONO'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object dchlEstendiIntervalloPMT: TDBCheckBox
          Tag = 1
          Left = 8
          Top = 83
          Width = 322
          Height = 16
          Alignment = taLeftJustify
          Caption = 'Intervallo mat. / pom. comprensivo della detrazione mensa'
          DataField = 'ESTENDI_INTERVALLO_PMT'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
      ...
      object dedtAssenzeTollPerc: TDBEdit
        Left = 214
        Top = 103
        Width = 143
        Height = 21
        Color = cl3DLight
        DataField = 'ASSENZE_TOLL_PERC'
        DataSource = DButton
        ReadOnly = True
        TabOrder = 12
      end
      object btnAssenzeTollPerc: TButton
        Left = 357
        Top = 103
        Width = 14
        Height = 21
      ...
      object dedtPercTollAssenze: TDBEdit
        Left = 374
        Top = 103
        Width = 40
        Height = 21
        DataField = 'PERC_TOLL_ASSENZE'
        DataSource = DButton
        MaxLength = 5
        TabOrder = 14
      end
      object grpFascia3: TGroupBox
        Left = 122
        Top = 311
        Width = 109
        Height = 136
        Caption = '3'#176' fascia'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        ...
        object lblOreMinimeFascia3: TLabel
          Left = 8
          Top = 55
          Width = 52
          Height = 13
        ...
        object dedtOreMinimeFascia3: TDBEdit
          Left = 8
          Top = 69
          Width = 40
          Height = 21
          DataField = 'OREMINIME_FASCIA3'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
      ...
      object dedtAssenzeDiminuzioneIncluse: TDBEdit
        Left = 3
        Top = 140
        Width = 188
        Height = 21
        HelpType = htKeyword
        Color = cl3DLight
        DataField = 'ASSENZE_DIMINUZIONE_INCLUSE'
        DataSource = DButton
        ReadOnly = True
        TabOrder = 17
      end
      object btnAssenzeDiminuzioneIncluse: TButton
        Left = 191
        Top = 140
        Width = 14
        Height = 21
        Caption = '...'
        TabOrder = 18
        OnClick = btnAssenzeDiminuzioneIncluseClick
      end
      object dchkConsideraGGSucc: TDBCheckBox
        Tag = 1
        Left = 214
        Top = 70
        Width = 200
        Height = 16
        Alignment = taLeftJustify
        Caption = 'Considera uscita sul gg. succ.'
        DataField = 'CONSIDERA_GGSUCC'
        DataSource = DButton
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
      ...
      object dedtOrariInibiti: TDBEdit
        Left = 424
        Top = 140
        Width = 187
        Height = 21
        Color = cl3DLight
        DataField = 'ORARI_INIBITI'
        DataSource = DButton
        ReadOnly = True
        TabOrder = 19
      end
      object btnOrariInibiti: TButton
        Left = 611
        Top = 140
        Width = 14
        Height = 21
