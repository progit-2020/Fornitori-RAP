...
begin
  ...
  begin
    ...
    begin
      ...
      for j:=1 to Num do
      begin
        m_tab_timbrature[i,j].toratimb:=VarToDateTime(A000FGestioneTimbraGiustMW.FTimbrature[i,j].Ora);
...
begin
  ...
  begin
    tmpLstAnomalieGiorno.Add(DateToStr(Giorno) + ': anomalia bloccante! ' + tdescanom1[R502ProDtM1.Blocca].D);
