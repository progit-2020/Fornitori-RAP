inherited Ac01FProgettiRendiProjMW: TAc01FProgettiRendiProjMW
  ...
  object selbT750: TOracleDataSet
    SQL.Strings = (
      
        'select T750.CODICE, T750.DECORRENZA, T750.DECORRENZA_FINE, T750.' +
        'DESCRIZIONE, T750.ID, T750.CAUASSPRES_INCLUSE'
      'from T750_PROGETTI_RENDICONTO T750'
      'where T750.ID <> :ID_T750'
      'order by T750.CODICE')
    Optimize = False
    Variables.Data = {
      0400000001000000100000003A00490044005F00540037003500300003000000
      0000000000000000}
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      1800000050005200450053004300520049005A0049004F004E00450001000000
      00001400000044004100540041005F0045005300490054004F00010000000000}
    OnFilterRecord = selbT750FilterRecord
    Left = 24
    Top = 296
  end
  object updCauIncluse: TOracleQuery
    SQL.Strings = (
      'update T750_PROGETTI_RENDICONTO'
      'set CAUASSPRES_INCLUSE = :CAUSALI'
      'where CODICE = :CODICE'
      'and DECORRENZA = :DECORRENZA')
    Optimize = False
    Variables.Data = {
      04000000030000000E0000003A0043004F004400490043004500050000000000
      000000000000100000003A00430041005500530041004C004900050000000000
