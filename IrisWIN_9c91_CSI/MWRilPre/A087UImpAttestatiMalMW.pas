  ...
  try
    ...
    begin
      ...
      begin
        ...
        CDtsTemp.FieldByName('datainizio_attestato').Value:=ConvData(CDtsTemp.FieldByName('dataricovero_ricovero').Value);
        CDtsTemp.FieldByName('datafine_attestato').Value:=ConvData(CDtsTemp.FieldByName('dataricovero_ricovero').Value);
      ...
      begin
        ...
        CDtsTemp.FieldByName('datainizio_attestato').Value:=ConvData(GetCampo('dataricovero_dimissioni'));
        CDtsTemp.FieldByName('datafine_attestato').Value:=ConvData(GetCampo('datadimissioni_dimissioni'));
      ...
      if Not CDtsTemp.FieldByName('datainizio_attestato').IsNull  then
        CDtsTemp.FieldByName('datainizio_attestato').Value:=ConvData(CDtsTemp.FieldByName('datainizio_attestato').Value);
      if Not CDtsTemp.FieldByName('datafine_attestato').IsNull  then
        CDtsTemp.FieldByName('datafine_attestato').Value:=ConvData(CDtsTemp.FieldByName('datafine_attestato').Value);
      if Not CDtsTemp.FieldByName('datarilascio_attestato').IsNull  then
        CDtsTemp.FieldByName('datarilascio_attestato').Value:=ConvData(CDtsTemp.FieldByName('datarilascio_attestato').Value);
      ...
      try
        ...
        begin
          ...
          if ScriptIDPrecedente.GetVariable('DATAOUT') <> null then
            DataInizioMalattia:=VarToDateTime(ScriptIDPrecedente.GetVariable('DATAOUT'));
        end;
        ...
        begin
          ...
          if (selT048ContinuaMal.GetVariable('NUOVA_DATA_INIZIO_MAL') <> null) then
            DataInizioMalattia:=VarToDateTime(selT048ContinuaMal.GetVariable('NUOVA_DATA_INIZIO_MAL'));
        end
        else
        begin
