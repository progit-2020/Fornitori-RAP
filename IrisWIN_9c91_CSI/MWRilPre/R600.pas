...
var i,j:Integer;
    ...
    sumVariazionePartTime,sumVariazioneAbilitazioneAnagrafica,sumVariazioneCompetenzeF,
...
begin
  ...
  RiepilogoAssenze[i].CompLordeAC:=R180GiorniOreToStr(ValCompTotali + IfThen(Trim(DescrizioneProfiloAssenze) <> '',ValVariazionePartTime),UMisura,'%3.2f');
  ...
  RiepilogoAssenze[i].CompNetteAC:=R180GiorniOreToStr(ValCompTotali + IfThen(Trim(DescrizioneProfiloAssenze) <> '',ValVariazionePartTime) - ValVariazionePeriodiRapporto - ValCompArrotondate - ValCompSoloFerie - ValVariazionePartTime - ValVariazioneAbilitazioneAnagrafica + ValVariazioneCompetenzeF + ValVariazioneFruizMMInteri + ValVariazioneMaxIndividuale + ValVariazioneFruizMMContinuativi + ValVariazioneGGNoLavVuoti + ValVariazioneFestePartic,UMisura,'%3.2f');
  ...
  begin
    ...
    RiepilogoAssenze[i].CompLordeAC:=R180GiorniOreToStr(sumCompTotali + IfThen(RiepilogoAssenze[i].ProfiloAssenze <> '',sumVariazionePartTime),saveUMisura,'%3.2f');
    ...
    RiepilogoAssenze[i].CompNetteAC:=R180GiorniOreToStr(sumCompTotali + IfThen(RiepilogoAssenze[i].ProfiloAssenze <> '',sumVariazionePartTime) - sumVariazionePeriodiRapporto - sumCompArrotondate - sumCompSoloFerie - sumVariazionePartTime - sumVariazioneAbilitazioneAnagrafica + sumVariazioneCompetenzeF + sumVariazioneFruizMMInteri + sumVariazioneMaxIndividuale + sumVariazioneFruizMMContinuativi + sumVariazioneGGNoLavVuoti + sumVariazioneFestePartic,saveUMisura,'%3.2f');
  end;
