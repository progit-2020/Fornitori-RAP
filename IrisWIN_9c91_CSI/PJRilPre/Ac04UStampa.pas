...
type
  ...
  private
    ...
    ThousandSepOri: Char;
    LeftIniMeseTitolo,LeftIniMeseValore:Integer;
  public
    { Public declarations }
...
begin
  ...
  with Ac04FStampaRendiProjDM.Ac04FStampaRendiProjMW do
  begin
    qlblTipoTempo.Visible:=TipoTempo;
    dlblTipoTempo.Visible:=TipoTempo;
    if TipoTempo then
    begin
    ...
    qlblGiustificaRitardoDip.Visible:=SezGiustificaRitardi;
    qlblGiustificaRitardoResp.Visible:=SezGiustificaRitardi;
  end;
end;
