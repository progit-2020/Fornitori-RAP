...
type
  ...
  public
    ...
    function AutenticazioneDominio(const DomainName, UserName, Password:String; TipoAutenticazione:String = 'NTLM'):Boolean;
  end;
...
function TA001FPassWordDtM1.AutenticazioneDominio(const DomainName, UserName, Password:String; TipoAutenticazione:String = 'NTLM'):Boolean;
var AdsOO:Integer;
    Obj:IADs;
begin
  // originale
