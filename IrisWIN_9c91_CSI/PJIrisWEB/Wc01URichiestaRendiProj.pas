  ...
  try
    ...
    try
      DCOMConnection1.AppServer.PrintAc04(SelezioneAnagrafica,
                                          ...
                                          '{"edtDaData":"' + FormatDateTime('mm/yyyy',Wc01DM.Dal) + '","edtAData":"' + FormatDateTime('mm/yyyy',Wc01DM.Dal) + '","chkSoloAttRend":"N","edtNumColAltriProgetti":"5","clbProgetti":"' + FiltroProgetto + '"}',
                                          DettaglioLog);
    finally
