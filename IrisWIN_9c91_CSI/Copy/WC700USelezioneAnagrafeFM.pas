  ...
  begin
    ...
    begin
      ...
      if ((rdgPeriodoConsiderato.ItemIndex = 0) and ((DataInizioRap > FDataLavoro) or (DataFineRap < FDataLavoro))) or
         ((rdgPeriodoConsiderato.ItemIndex = 1) and ((FDataLavoro < DataInizioRap) or (VarToDateTime((grdAnteprima.medpDataSet as TOracleDataset).GetVariable('C700DATADAL')) > DataFineRap))) then
