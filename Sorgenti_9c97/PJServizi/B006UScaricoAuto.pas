...
uses
  ...
  OracleData,ShellAPI, C180FunzioniGenerali, Variants, System.Actions;
...
type
  ...
  private
    SessioneOracleB006:TOracleSession;
    // rimozione variabile globale R200FScaricoTimbratureDtM.ini
...
const
  B006_SERVICE_EXENAME = 'B006PSCARICOSERVICE.EXE';
  B006_SERVICE_NAME    = 'B006FSCARICOSERVICE';
...
begin
  ShellExecute(0,'open', PChar(ExtractFilePath(Application.ExeName) + 'B006PSCARICOSERVICE.EXE'),PChar('/INSTALL'),nil,SW_SHOWNORMAL);
end;
...
begin
  BitBtn3Click(nil);
  PutParametriFunzione;
  ShellExecute(0,'open', PChar('NET'),PChar('START B006FSCARICOSERVICE'),nil,SW_SHOWNORMAL);
end;

procedure TB006FScaricoAuto.Arresta1Click(Sender: TObject);
begin
  ShellExecute(0,'open', PChar('NET'),PChar('STOP B006FSCARICOSERVICE'),nil,SW_SHOWNORMAL);
end;

procedure TB006FScaricoAuto.Disinstalla1Click(Sender: TObject);
begin
  ShellExecute(0,'open', PChar(ExtractFilePath(Application.ExeName) + 'B006PSCARICOSERVICE.EXE'),PChar('/UNINSTALL'),nil,SW_SHOWNORMAL);
end;
