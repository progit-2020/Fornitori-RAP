object B019FGeneratoreStampeDtM: TB019FGeneratoreStampeDtM
  ...
  object selT926: TOracleDataSet
    SQL.Strings = (
      ...
      'where ID = :ID'
      'order by nvl(ORDINE,0),APPLICAZIONE,CODICE_STAMPA'
      '')
    Optimize = False
    ...
    object selT926ORDINE: TIntegerField
      DisplayLabel = 'Ordine'
      DisplayWidth = 5
      FieldName = 'ORDINE'
    end
    ...
    object selT926SQL_AFTER: TStringField
      DisplayLabel = 'Script SQL a fine elab.'
      DisplayWidth = 10
      FieldName = 'SQL_AFTER'
      Size = 1000
    end
  ...
  object selSqlAfter: TOracleQuery
    Optimize = False
    Left = 504
    Top = 80
  end
