...
uses
  ...
  medpIWImageButton, W005UCartellinoFM, medpIWMultiColumnComboBox;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (StatoAllegati.Condizione = aObbAssenti) and (WR000DM.Responsabile) then
      begin
        if (TmeIWGrid(grdRichieste.medpCompGriglia[i].CompColonne[grdRichieste.medpIndexColonna('D_AUTORIZZAZIONE')]).Cell[0,0].Control is TmeIWCheckBox) and
           ((TmeIWGrid(grdRichieste.medpCompGriglia[i].CompColonne[grdRichieste.medpIndexColonna('D_AUTORIZZAZIONE')]).Cell[0,0].Control as TmeIWCheckBox).Caption = 'Si') then
          TmeIWGrid(grdRichieste.medpCompGriglia[i].CompColonne[grdRichieste.medpIndexColonna('D_AUTORIZZAZIONE')]).Cell[0,0].Css:='invisibile';
      end;
    end;
    // EMPOLI_ASL11 - commessa 2014/054 SVILUPPO#2.fine
    ...
    begin
      ...
      begin
        if StileCella1 = '' then
        begin
          StileCella1:=TmeIWGrid(grdRichieste.medpCompGriglia[i].CompColonne[0]).Cell[0,0].Css;
          if C018.EsisteAutorizzIntermedia then
            StileCella2:=TmeIWGrid(grdRichieste.medpCompGriglia[i].CompColonne[0]).Cell[0,2].Css;
        end;
