...
var RecNOI095,RecNOI096:Integer;
begin
  RecNOI095:=selI095.RecNO;
  RecNOI096:=selI096.RecNO;
  SessioneOracle.ApplyUpdates([A115MW.selI094],True);
  inherited;
  if (RecNOI095 > 0) and (RecNOI095 <= selI095.RecordCount) then
    selI095.RecNO:=RecNOI095;
  if (RecNOI096 > 0) and (RecNOI096 <= selI096.RecordCount) then
    selI096.RecNO:=RecNOI096;
end;
