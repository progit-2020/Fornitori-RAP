inherited A004FGiustifAssPresMW: TA004FGiustifAssPresMW
  ...
  object Q265: TOracleDataSet
    SQL.Strings = (
      'Select '
        ...
        '  Codice,Descrizione,Cumulo_Familiari,Fruizione_Familiari,Cumulo' +
        'Globale,'
  ...
  object selConiuge: TOracleDataSet
    SQL.Strings = (
      'SELECT '#39'GENITORI'#39' TIPO,COUNT(*) NUM '
      'FROM SG101_FAMILIARI '
      
        'WHERE PROGRESSIVO = :PROGRESSIVO AND GRADOPAR IN ('#39'CG'#39','#39'AL'#39','#39'UC'#39 +
        ','#39'CF'#39') AND MATRICOLA IS NULL'
      ''
      'union all'
      ''
      'SELECT '#39'FAMILIARI'#39' TIPO,COUNT(*) NUM '
      'FROM SG101_FAMILIARI '
      'WHERE PROGRESSIVO = :PROGRESSIVO AND MATRICOLA IS NULL')
    Optimize = False
    Variables.Data = {
      0400000001000000180000003A00500052004F00470052004500530053004900
      56004F00030000000000000000000000}
