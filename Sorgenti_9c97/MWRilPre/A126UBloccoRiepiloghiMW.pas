...
type
  ...
  public
    ...
    procedure ScriviLog(Blocco:Boolean;RiepiloghiSelezionati:String;ProgressivoCorrente:Integer);
...
procedure TA126FBloccoRiepiloghiMW.ScriviLog(Blocco:Boolean;RiepiloghiSelezionati:String;ProgressivoCorrente:Integer);
begin
  if Blocco then
  begin
    ...
    RegistraLog.InserisciDato('PROGRESSIVO','',IntToStr(ProgressivoCorrente));
  end
  else
  begin
