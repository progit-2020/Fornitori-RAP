...
type
  ...
  private
    ...
    const
       D_DatiStoricizzatiT235: array[0..6] of TA020DescrizioneElementoStorico = (
         ...
         (Nome:'ARROT_RIEPGG';               Descrizione:'Arrotondamento'),
         (Nome:'ARROT_RIEPGG_ORENORM';       Descrizione:'Arrotondamento:Mantiene il resto nelle ore normali'),
         (Nome:'ARROT_RIEPGG_FASCE';         Descrizione:'Arrotondamento:Applica l''arrotondamento alle fasce'),
         (Nome:'ARROT_RIEPGG_FINECONT';      Descrizione:'Arrotondamento:Applica dopo la compens. del debito')
       );
