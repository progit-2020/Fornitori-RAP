    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            //PINEROLO_COMUNE: esclusione spezzoni già causalizzati
            if   (Parametri.CampiRiferimento.C90_W026SpezzoniNonCaus = 'S')
            and  (timbArr[i].tcausale_e.tcaus <> '')
            and  (not R180In(ValStrT275[timbArr[i].tcausale_e.tcaus,'TIPO_RICHIESTA_WEB'],['P','R']))
            and  (not R180In(timbArr[i].tcausale_e.tcaus,[Parametri.CampiRiferimento.C90_W026CausE,Parametri.CampiRiferimento.C90_W026CausU]))
            then
              Continue;
            // straordinario (P)
