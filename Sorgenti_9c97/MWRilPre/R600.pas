...
begin
  ...
  begin
    ...
    ArrOrd[i].MatricolaFamiliare:=ArrSrc[i].MatricolaFamiliare;
...
var
  ...
  begin
    ...
    // TORINO_CSI - commessa 2015/142 SVILUPPO#7.ini
    R600FVisAssenzeCumulate.Width:=550;
    // TORINO_CSI - commessa 2015/142 SVILUPPO#7.fine
      ...
      begin
        ...
        begin
          ...
          if AssenzeCumulateOrdData[i].Coniuge then
            Cells[7,RowCount]:=IfThen(AssenzeCumulateOrdData[i].MatricolaFamiliare = '','Non dip.',AssenzeCumulateOrdData[i].MatricolaFamiliare);
          Cells[8,RowCount]:=IfThen(AssenzeCumulateOrdData[i].RichiestaWeb,'SI','');
          RowCount:=RowCount + 1;
        end;
      end;
    ...
    // elenco dei periodi
    // TORINO_CSI - commessa 2015/142 SVILUPPO#7.ini
    R600FVisPeriodiCumulati.Width:=720;
    // TORINO_CSI - commessa 2015/142 SVILUPPO#7.fine
    ...
    begin
      ...
      begin
        ...
        Cells[5,i + 1]:='';
        if PeriodiCumulati[i].Coniuge then
          Cells[5,i + 1]:=IfThen(PeriodiCumulati[i].MatricolaFamiliare = '','Non dip.',PeriodiCumulati[i].MatricolaFamiliare);
        // TORINO_CSI - commessa 2015/142 SVILUPPO#7.ini
        Cells[6,i + 1]:=FloatToStr(PeriodiCumulati[i].NumGiorniDip);
        Cells[7,i + 1]:=FloatToStr(PeriodiCumulati[i].NumGiorniConiuge);
        Cells[8,i + 1]:=FloatToStr(PeriodiCumulati[i].NumGiorni);
        // TORINO_CSI - commessa 2015/142 SVILUPPO#7.fine
      end;
      if RowCount = 1 then
        RowCount:=2;
...
begin
  ...
  *)
  ...
  begin
    ...
    cdsFruizioni.FieldByName('MATRICOLA_FAMILIARE').AsString:='';
...
begin
  ...
  begin
    ...
    begin
      ...
      if R180CarattereDef(Q265.FieldByName('CUMULO_FAMILIARI').AsString,1,'N') in ['S','D'] then
        ...
        Q.SQL.Add('/*+ INDEX(T040_GIUSTIFICATIVI T040_PK)*/');
      // ALESSANDRIA_COMUNE - commessa 2015/214 SVILUPPO#1.ini
      Q.SQL.Add('T040.PROGRESSIVO,T040.DATA,T040.CAUSALE,T040.PROGRCAUSALE,T040.TIPOGIUST,T040.CSI_TIPO_MG,T040.DAORE,T040.AORE,''N'' CONIUGE, to_char(null) MATRICOLA_FAMILIARE FROM'); //Lorena 3/12/2002
      // ALESSANDRIA_COMUNE - commessa 2015/214 SVILUPPO#1.fine
      Q.SQL.Add('T040_GIUSTIFICATIVI T040,T265_CAUASSENZE T265');
      Q.SQL.Add('WHERE');
      Q.SQL.Add('T040.PROGRESSIVO = :PROGRESSIVO AND');
      ...
      Q.SQL.Add('SELECT');
      // ALESSANDRIA_COMUNE - commessa 2015/214 SVILUPPO#1.ini
      Q.SQL.Add('T046.PROGRESSIVO,T046.DATA,T046.CAUSALE,-1,T046.TIPOGIUST,null,TO_DATE(''30121899''||NVL(T046.DAORE,''00.00''),''DDMMYYYYHH24.MI''),TO_DATE(''30121899''||NVL(T046.AORE,''00.00''),''DDMMYYYYHH24.MI''),''S'' CONIUGE, to_char(null) MATRICOLA_FAMILIARE FROM'); //Lorena 3/12/2002
      // ALESSANDRIA_COMUNE - commessa 2015/214 SVILUPPO#1.fine
    ...
    begin
      ...
      if R180CarattereDef(Q265.FieldByName('CUMULO_FAMILIARI').AsString,1,'N') in ['S','D'] then
        Q.SQL.Add('/*+ INDEX(T040_GIUSTIFICATIVI T040_DATANAS)*/');
      // ALESSANDRIA_COMUNE - commessa 2015/214 SVILUPPO#1.ini
      Q.SQL.Add('T040.PROGRESSIVO,T040.DATA,T040.CAUSALE,T040.PROGRCAUSALE,T040.TIPOGIUST,T040.CSI_TIPO_MG,T040.DAORE,T040.AORE,DECODE(T040.PROGRESSIVO,:PROG1,''N'',:PROG2,''S'') CONIUGE, T030.MATRICOLA MATRICOLA_FAMILIARE FROM');  //Lorena 3/12/2002
      // ALESSANDRIA_COMUNE - commessa 2015/214 SVILUPPO#1.fine
      Q.SQL.Add('T040_GIUSTIFICATIVI T040,T265_CAUASSENZE T265,T030_ANAGRAFICO T030');
      Q.SQL.Add('WHERE');
      Q.SQL.Add('T040.PROGRESSIVO IN (:PROG1,:PROG2) AND');
      Q.SQL.Add('T040.DATA BETWEEN :DATA1 AND :DATA2 AND');
      Q.SQL.Add('exists (select ''X'' from dual where T050F_CANCELLATA(T040.ID_RICHIESTA,T040.DATA) = ''N'') AND');
      Q.SQL.Add('T040.PROGRESSIVO = T030.PROGRESSIVO AND');
      Q.SQL.Add('T265.CODICE = T040.CAUSALE AND');
      Q.SQL.Add('(T265.CODRAGGR = :RAGGRUPPAMENTO');
      if S <> '' then
        Q.SQL.Add('OR T040.CAUSALE IN(' + S + ')');
  ...
  else if Q265.FieldByName('CUMULOGLOBALE').AsString = 'F' then
  begin
    //Familiari (L104)
    //E' obbligatorio il riferimento a RiferimentoDataNascita.Data
    Q.SQL.Clear;
    Q.SQL.Add('select');
    Q.SQL.Add('/*+ INDEX(T040_GIUSTIFICATIVI T040_DATANAS)*/');
    Q.SQL.Add('T040.PROGRESSIVO,T040.DATA,T040.CAUSALE,T040.PROGRCAUSALE,T040.TIPOGIUST,T040.CSI_TIPO_MG,T040.DAORE,T040.AORE,DECODE(T040.PROGRESSIVO,:PROGRESSIVO,''N'',''S'') CONIUGE, T030.MATRICOLA MATRICOLA_FAMILIARE');
    Q.SQL.Add('from T040_GIUSTIFICATIVI T040,T265_CAUASSENZE T265, T030_ANAGRAFICO T030');
    Q.SQL.Add('where T040.PROGRESSIVO in (');
    Q.SQL.Add('  select :PROGRESSIVO from dual');
    Q.SQL.Add('  union');
    Q.SQL.Add('  select T030.PROGRESSIVO from SG101_FAMILIARI SG101, T030_ANAGRAFICO T030');
    Q.SQL.Add('  where SG101.PROGRESSIVO = :PROGRESSIVO');
    Q.SQL.Add('  and SG101.MATRICOLA = T030.MATRICOLA');
    Q.SQL.Add('  and DECORRENZA <= :DATA2 and DECORRENZA_FINE >= :DATA1');
    Q.SQL.Add('  )');
    Q.SQL.Add('and T040.DATA between :DATA1 and :DATA2');
    Q.SQL.Add('and exists (select ''X'' from dual where T050F_CANCELLATA(T040.ID_RICHIESTA,T040.DATA) = ''N'')');
    Q.SQL.Add('and T040.PROGRESSIVO = T030.PROGRESSIVO');
    Q.SQL.Add('and T265.CODICE = T040.CAUSALE');
    Q.SQL.Add('and (T265.CODRAGGR = :RAGGRUPPAMENTO');
    if S <> '' then
      Q.SQL.Add('or T040.CAUSALE in (' + S + ')');
    Q.SQL.Add(')');
    Q.SQL.Add('and T040.DATANAS = :DATANAS');
    Q.SQL.Add('union all');
    Q.SQL.Add('select');
    Q.SQL.Add('T046.PROGRESSIVO,T046.DATA,T046.CAUSALE,-1,T046.TIPOGIUST,null,TO_DATE(''30121899''||NVL(T046.DAORE,''00.00''),''DDMMYYYYHH24.MI''),TO_DATE(''30121899''||NVL(T046.AORE,''00.00''),''DDMMYYYYHH24.MI''),''S'' CONIUGE, null MATRICOLA_FAMILIARE');
    Q.SQL.Add('from T046_GIUSTIFICATIVIFAMILIARI T046,T265_CAUASSENZE T265');
    Q.SQL.Add('where');
    Q.SQL.Add('T046.PROGRESSIVO in (');
    Q.SQL.Add('  select :PROGRESSIVO from dual');
    Q.SQL.Add('  union');
    Q.SQL.Add('  select T030.PROGRESSIVO from SG101_FAMILIARI SG101, T030_ANAGRAFICO T030');
    Q.SQL.Add('  where SG101.PROGRESSIVO = :PROGRESSIVO');
    ...
    Q.SQL.Add('  and DECORRENZA <= :DATA2 and DECORRENZA_FINE >= :DATA1');
    Q.SQL.Add('  )');
    Q.SQL.Add('and T046.DATA between :DATA1 and :DATA2');
    Q.SQL.Add('and T265.CODICE = T046.CAUSALE');
    Q.SQL.Add('and (T265.CODRAGGR = :RAGGRUPPAMENTO');
    if S <> '' then
      Q.SQL.Add('or T046.CAUSALE in (' + S + ')');
    Q.SQL.Add(')');
    Q.SQL.Add('and T046.DATANAS = :DATANAS');
    Q.SQL.Add('order by DATA,MATRICOLA_FAMILIARE,CAUSALE,PROGRCAUSALE');
    Q.DeclareVariable('DATANAS',otDate);
    Q.SetVariable('DATANAS',RiferimentoDataNascita.Data);
    Q.DeclareVariable('PROGRESSIVO',otInteger);
    Q.SetVariable('Progressivo',Progressivo);
  ...
  *)
  ...
  begin
    ...
    cdsFruizioni.FieldByName('DAORE').Value:=Q.FieldByName('DAORE').Value;
    cdsFruizioni.FieldByName('AORE').Value:=Q.FieldByName('AORE').Value;
    if R180In(Q265.FieldByName('CUMULOGLOBALE').AsString,['C','F']) then
    begin
      cdsFruizioni.FieldByName('CONIUGE').AsString:=Q.FieldByName('CONIUGE').AsString;
      cdsFruizioni.FieldByName('MATRICOLA_FAMILIARE').AsString:=Q.FieldByName('MATRICOLA_FAMILIARE').AsString;
    end
    else
    begin
      cdsFruizioni.FieldByName('CONIUGE').AsString:='N';
  ...
  begin
    ...
    R180SetVariable(selT050,'FAMILIARI',null);
    if Q265.FieldByName('CUMULOGLOBALE').AsString = 'F' then
    begin
      R180SetVariable(selT050,'FAMILIARI','or T050.PROGRESSIVO in (' +
                                          'select T030B.PROGRESSIVO from SG101_FAMILIARI SG101, T030_ANAGRAFICO T030B' +
                                          ' where SG101.PROGRESSIVO = :PROG1' +
                                          ' and SG101.MATRICOLA = T030B.MATRICOLA' +
                                          ' and SG101.DECORRENZA <= :DATA2 and SG101.DECORRENZA_FINE >= :DATA1)');
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          cdsFruizioni.FieldByName('MATRICOLA_FAMILIARE').AsString:=selT050.FieldByName('MATRICOLA_FAMILIARE').AsString;
        end
        else
        begin
          cdsFruizioni.FieldByName('CONIUGE').AsString:='N';
  ...
  begin
    ...
    begin
      ...
      AssenzeCumulate[i].Coniuge:=FieldByName('CONIUGE').AsString = 'S';
      AssenzeCumulate[i].MatricolaFamiliare:=FieldByName('MATRICOLA_FAMILIARE').AsString;
...
begin
  ...
  cdsFruizioni.FieldDefs.Add('MATRICOLA_FAMILIARE',ftString,8);
...
begin
  ...
  begin
    ...
    GiustificativiR600[x].MatricolaFamiliare:=cdsFruizioni.FieldByName('MATRICOLA_FAMILIARE').AsString;
  end;
end;
    ...
    begin
      if (AssenzeCumulateOrdData[i].DTData > DUP + 1) or
         ((i > 0) and ((AssenzeCumulateOrdData[i].Tipo <> AssenzeCumulateOrdData[i - 1].Tipo) or
                       ...
                       (AssenzeCumulateOrdData[i].Coniuge <> AssenzeCumulateOrdData[i - 1].Coniuge) or
                       (AssenzeCumulateOrdData[i].MatricolaFamiliare <> AssenzeCumulateOrdData[i - 1].MatricolaFamiliare)) then
      begin
        inc(Result);
        ...
        PeriodiCumulati[Result - 1].MatricolaFamiliare:=AssenzeCumulateOrdData[i].MatricolaFamiliare;
        // TORINO_CSI - commessa 2015/142 SVILUPPO#7.ini
        LNumGiorniDip:=0;
        LNumGiorniConiuge:=0;
        LNumGiorni:=0;
