...
uses
  ...
  A006UModelliOrario,A007UProfiliOrari,A009UProfiliAsse,
  ...
  A110UParametriConteggio,A111UParmessaggi,A112UInvioMessaggi,A113UParestrazioniStampe,A114UEstrazioniStampe, A115UIterAutorizzativi,
  A005UDatiLiberi,A116ULiquidazioneOreAnniPrec,A117UOreLiquidateAnniPrec,
  ...
  A170UGestioneGruppi,A172USchedeQuantIndividuali,A173UImportAssestamento,A176URiepilogoIterAutorizzativi,
...
begin
  ...
  try
    ...
    else if Sender = actIterAutorizzativi then
      OpenA115IterAutorizzativi
    else if Sender = actRiepilogoIterAutorizzativi then
      OpenA176RiepilogoIterAutorizzativi
