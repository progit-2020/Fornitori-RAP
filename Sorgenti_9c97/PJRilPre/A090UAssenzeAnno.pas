...
type
  TA090FAssenzeAnno = class(TForm)
    ...
    rgpRichiesteIrisWEB: TRadioGroup;
...
begin
  ...
  begin
    ...
    case rgpRichiesteIrisWEB.ItemIndex of
      0: SetVariable('RICHIESTE_WEB','N');
      1: SetVariable('RICHIESTE_WEB','R');
      2: SetVariable('RICHIESTE_WEB','A');
    end;
  end;
...
begin
  ...
  begin
    ...
    rgpRichiesteIrisWEB.ItemIndex:=C004FParamForm.GetParametro(UpperCase(rgpRichiesteIrisWEB.Name),'0').ToInteger;
...
begin
  ...
  with A090FAssenzeAnno do
    ...
    C004FParamForm.PutParametro(UpperCase(rgpRichiesteIrisWEB.Name),rgpRichiesteIrisWEB.ItemIndex.ToString);
