...
const
  ...
  A000selDizionario = 'SELECT ''CAUSALI ASSENZA'' TABELLA,CODICE FROM T265_CAUASSENZE UNION' + #13#10 +
                      ...
                      'SELECT ''PROGETTI RENDICONTABILI'' TABELLA, TO_CHAR(ID) AS CODICE FROM T750_PROGETTI_RENDICONTO UNION' + #13#10 +
                      'SELECT ''ITER AUTORIZZATIVI'' TABELLA, ITER CODICE FROM MONDOEDP.I093_BASE_ITER_AUT WHERE AZIENDA = I090F_GETAZIENDACORRENTE';//+ subquery dinamica di A000selDizionarioSicurezzaRiepiloghi

  TabelleDizionario:array[1..28] of TTabelleDizionario = (
    ...
    (Tabella:'-';                         DescTabella:'MANIPOLAZIONE DATI'),//subquery dinamica di A000selDizionarioSicurezzaRiepiloghi
  ...
  DatiEnte:array [1..156] of TDatiEnte = (
    ...
    (Nome:'C23_VMH_CUMULO_TRIENNIO';                  Gruppo:'Varie';               Lista:'SN';                Desc:'La Visita medica ad ore è cumulata nel triennio'),
    (Nome:'C25_TIMBIRR_AUTO';                         Gruppo:'Varie';               Lista:'SN';                Desc:'Ripristino automatico timbr.irregolari'),
    (Nome:'C29_CHIAMATEREP_FILTRO1';                  Gruppo:'Varie';               Lista:'T430';              Desc:'Reperibilità: filtro 1'),
    (Nome:'C29_CHIAMATEREP_FILTRO2';                  Gruppo:'Varie';               Lista:'T430';              Desc:'Reperibilità: filtro 2'),
    (Nome:'C29_CHIAMATEREP_DATIVIS';                  Gruppo:'Varie';               Lista:'T430_MULTI';        Desc:'Reperibilità: dati da visualizzare nelle info'),
    (Nome:'C29_CHIAMATEREP_DATIMODIF';                Gruppo:'Varie';               Lista:'T430_MULTI';        Desc:'Reperibilità: dati modificabili dalle chiamate'),
    ...
    (Nome:'C3_INDPRES';                               Gruppo:'Profili indennità';   Lista:'T430';              Desc:'Indennità di presenza (Liv.1)'),
    (Nome:'C3_INDPRES2';                              Gruppo:'Profili indennità';   Lista:'T430';              Desc:'Indennità di presenza (Liv.2)'),
    (Nome:'C3_DATOPIANIFICABILE';                     Gruppo:'Profili indennità';   Lista:'C3_INDPRES';        Desc:'Indennità di presenza - Liv.pianificabile'),
    (Nome:'C3_RIEPTURNI_INDPRES';                     Gruppo:'Profili indennità';   Lista:'SN';                Desc:'Riepilogo turni solo se maturazione indennità'),
    (Nome:'C3_DETTGG_TIPOI';                          Gruppo:'Profili indennità';   Lista:'SN';                Desc:'Salvataggio dettaglio GG per ind.oraria'),
    (Nome:'C3_INDENNITA_FUNZIONE';                    Gruppo:'Profili indennità';   Lista:'T430';              Desc:'Indennità di funzione'),
    ...
    (Nome:'C8_W032_MAX_ALLEGATI';                     Gruppo:'Missioni';            Lista:'NUMERICO';          Desc:'Trasferte web: max allegati consentiti per richiesta'),
    ...
    (Nome:'C20_INCARICOUNITAORG';                     Gruppo:'Giuridico';           Lista:'T430';              Desc:'Incarichi: unità organizzativa'),
    ...
    (Nome:'C37_SOLO_ATT_REND';                        Gruppo:'Rendicontazione progetti'; Lista:'SN';           Desc:'Rend. prog.: solo attività rendicontate'),
    ...
    (Nome:'C37_CUP';                                  Gruppo:'Rendicontazione progetti'; Lista:'SN';           Desc:'Rend. prog.: CUP'),
    (Nome:'C37_LOGO';                                 Gruppo:'Rendicontazione progetti'; Lista:'SN';           Desc:'Rend. prog.: logo'),
    ...
    (Nome:'C90_EMAIL_W010UFF';                        Gruppo:'IrisWEB-Email';       Lista:'SNI';               Desc:'Servizio mail per elaborazione assenze'),
    (Nome:'C90_EMAIL_W018UFF';                        Gruppo:'IrisWEB-Email';       Lista:'SNI';               Desc:'Servizio mail per elaborazione timbrature'),
    ...
    (Nome:'C90_W026SPEZZONI_NONCAUS';                 Gruppo:'IrisWEB-Ecced.gg';    Lista:'SN';                Desc:'Web: spezzoni ecced.gg solo se non causalizzati'),
