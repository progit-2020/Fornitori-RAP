...
begin
  ...
  selI096.Open;
  if Assigned(A181MW) then
    A181MW.AggiornaLivMax;
end;
...
begin
  ...
  A181MW.ModuloIterAutorizzativi:=A000ModuloAbilitato(SessioneOracle,'ITER_AUTORIZZATIVI',QI090.FieldByName('AZIENDA').AsString);
  GestAllegati:=True;//A000ModuloAbilitato(SessioneOracle,'PUBBL_DOCUMENTI_ESTERNI',QI090.FieldByName('AZIENDA').AsString);
