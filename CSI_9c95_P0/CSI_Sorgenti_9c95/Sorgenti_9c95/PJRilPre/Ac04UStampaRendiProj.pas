...
begin
  ...
  begin
    ...
    nProMax:=StrToIntDef(Parametri.CampiRiferimento.C37_NumColAltriProg,0);
    SoloAttRend:=Parametri.CampiRiferimento.C37_SoloAttRend = 'S';
    TipoTempo:=Parametri.CampiRiferimento.C37_TipoTempo = 'S';
    SezGiustificaRitardi:=Parametri.CampiRiferimento.C37_SezGiustRitardi = 'S';
    CUP:=Parametri.CampiRiferimento.C37_CUP = 'S';
    Logo:=Parametri.CampiRiferimento.C37_Logo = 'S';
