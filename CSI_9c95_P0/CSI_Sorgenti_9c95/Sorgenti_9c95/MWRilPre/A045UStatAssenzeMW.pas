...
begin
  ...
  TabellaStampa.FieldDefs.Add('NDipURagg13',ftInteger,0,False);
  TabellaStampa.FieldDefs.Add('NGioURagg13',ftFloat	,0,False);
  TabellaStampa.FieldDefs.Add('NDipDRagg13',ftInteger,0,False);
  TabellaStampa.FieldDefs.Add('NGioDRagg13',ftFloat	,0,False);
  ...
  while not selT043.Eof do begin
    ...
    begin
      ...
      TabellaStampa.FieldByName('Descrizione').AsString:=
        Format('%-75s',[Copy(selT043.FieldByName('Descrizione').AsString,1,75)]) + ' - ' + selT043.FieldByName('Codice').AsString;
      ...
      TabellaStampa.FieldByName('NDipURagg13').AsInteger:=0;
      TabellaStampa.FieldByName('NGioURagg13').AsFloat:=0;
      TabellaStampa.FieldByName('NDipDRagg13').AsInteger:=0;
      TabellaStampa.FieldByName('NGioDRagg13').AsFloat:=0;
    ...
    if selT043.FieldByName('COD_CODICIACCORPAMENTOASS').AsString = 'M' then
    begin
      if selT043.FieldByName('SESSO').AsString = 'M' then
      begin
        NomeGiorni:='NGioURagg13';
        NomeDip:='NDipURagg13';
      end
      else
      begin
        NomeGiorni:='NGioDRagg13';
        NomeDip:='NDipDRagg13';
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        TabellaStampa.FieldByName('NTotGioU').AsString:=FloatToStr(TabellaStampa.FieldByName('NGioURagg1').AsFloat + TabellaStampa.FieldByName('NGioURagg2').AsFloat +
          ...
          TabellaStampa.FieldByName('NGioURagg12').AsFloat + TabellaStampa.FieldByName('NGioURagg13').AsFloat);
      ...
      begin
        ...
        TabellaStampa.FieldByName('NTotGioD').AsString:=FloatToStr(TabellaStampa.FieldByName('NGioDRagg1').AsFloat + TabellaStampa.FieldByName('NGioDRagg2').AsFloat +
          ...
          TabellaStampa.FieldByName('NGioDRagg12').AsFloat + TabellaStampa.FieldByName('NGioDRagg13').AsFloat);
...
var i,j,ProgOld,NRagg:Integer;
  VettTotali: array [1..13] of Real;
  VettTotaliMin: array [1..13] of Real;
