  ...
  begin
    ...
    begin
      ...
      if (Blocca <> 0) and (FAnomalieLivello1) then
        ...
        begin
          QRLista.Add(Spazio + 'Anom.bloccante! ' + DescAnomaliaBloccante);
          A1:=True;
          if AggiornaT101 then
            SalvaAnomalia(SelAnagrafe.FieldByName('Progressivo').AsInteger,Corrente,1,DescAnomaliaBloccante, tdescanom1[Blocca].N);
        end;
