  ...
  object scrEMailResponsabile: TOracleQuery
    SQL.Strings = (
      ...
      '    select progressivo,'
        ...
        '           replace(replace(replace(replace(trim(filtro),'#39':nome_u' +
        'tente'#39','#39#39#39#39'|| p_utente ||'#39#39#39#39'),'#39':NOME_UTENTE'#39','#39#39#39#39'|| p_utente||'#39 +
        #39#39#39'),'#39':datalavoro'#39','#39'to_date('#39#39#39' || to_char(sysdate,'#39'dd/mm/yyyy'#39')' +
        ' || '#39#39#39','#39#39'dd/mm/yyyy'#39#39')'#39'),'#39':DATALAVORO'#39','#39'to_date('#39#39#39' || to_char(' +
        'sysdate,'#39'dd/mm/yyyy'#39') || '#39#39#39','#39#39'dd/mm/yyyy'#39#39')'#39') filtro'
      ...
      '  filtro       varchar2(4000); -- filtro anagrafe'
        ...
        '  filtro_norm  varchar2(4000); -- filtro anagrafe non ottimizzat' +
        'o'
      ...
      '      end if;'
      '    end loop;'
      '    if trim(filtro) is not null then'
      '      filtro:='#39' and ('#39' || trim(filtro) || '#39')'#39';'
      '    end if;    '
      '    filtro_norm:=filtro;'
      ''
      '    -- ottimizzazione query se il db ha la parte stipendiale'
      '    if TRUE or (:V430 = '#39'P430'#39') then'
      ...
      '        if instr(upper(filtro),'#39'T430.'#39') = 0 then'
      '          filtro:=replace(filtro,'#39'v430.'#39','#39'V430.'#39');'
      
        '          filtro:=replace(replace(filtro,'#39'V430.T430'#39','#39'T430.'#39'),'#39'V' +
        '430.t430'#39','#39'T430.'#39');'
      
        '          --filtro:=replace(replace(filtro,'#39'T430'#39','#39'T430.'#39'),'#39't430' +
        #39','#39'T430.'#39');'
      '        end if;  '
      '      end if;'
      '    else'
      ...
      '      exception'
      '        when others then'
      '          if espressione = espr_fast then'
      
        '            open c for espr_norm || filtro_norm using :progressi' +
        'vo;'
      '          else'
      '            raise;'
      '          end if;  '
