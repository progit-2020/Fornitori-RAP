...
begin
  inherited;
  if RichiamoEsterno and (Field <> nil) then
    exit;
...
begin
  ...
  if not RichiamoEsterno then
    selInputDati.Close;
  R180SetVariable(selInputDati,'TABELLA',NomeStruttura);
  R180SetVariable(selInputDati,'MEDP_IDMISSIONE',Null);
  R180SetVariable(selInputDati,'MEDP_CODRIMBORSO',Null);
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                selM150.FieldByName('STATO').AsString:=IfThen(selM040.RecordCount > 0,'I','A');
