inherited A110FParametriConteggio: TA110FParametriConteggio
  Left = 278
  Top = 177
  HelpContext = 110000
  Caption = '<A110> Regole trasferte'
  ClientHeight = 601
  ClientWidth = 532
  ...
  object Panel1: TPanel [4]
    ...
    BevelOuter = bvNone
    TabOrder = 2
    object LblArrTotaleImportiPerDatiPaghe: TLabel
      Left = 11
      Top = 154
      Width = 146
      Height = 13
    ...
    object LblTariffaDopoRiduzione: TLabel
      Left = 11
      Top = 193
      Width = 117
      Height = 13
    ...
    object dLblArrTotaleImportiPerDatiPaghe: TDBText
      Left = 78
      Top = 171
      Width = 160
      Height = 13
    ...
    object dLblTariffaDopoRiduzione: TDBText
      Left = 78
      Top = 210
      Width = 123
      Height = 13
    ...
    object GroupBox1: TGroupBox
      ...
      ParentFont = False
      TabOrder = 4
      object lblArrotondamentoOre: TLabel
        Left = 34
        Top = 22
        Width = 30
        Height = 13
      ...
      object dedtArrotondamentoOre: TDBEdit
        Left = 67
        Top = 19
        Width = 62
        Height = 21
      ...
      object dRgpTipoArrotondamento: TDBRadioGroup
        Left = 190
        Top = 12
        Width = 314
        Height = 31
    ...
    object dcmbArrTariffaDopoRiduzione: TDBLookupComboBox
      Left = 11
      Top = 205
      Width = 65
      Height = 21
      DataField = 'ARROTTARIFFADOPORIDUZIONE'
      DataSource = DButton
      DropDownWidth = 250
      KeyField = 'COD_ARROTONDAMENTO'
      ListField = 'COD_ARROTONDAMENTO;DESCRIZIONE;VALORE'
      PopupMenu = pmnParametri
      TabOrder = 6
      OnKeyDown = dcmbCodiceKeyDown
    end
    object dcmbArrTotaleImportiPerDatiPaghe: TDBLookupComboBox
      Left = 11
      Top = 167
      Width = 65
      Height = 21
      DataField = 'ARROTTOTIMPORTIDATIPAGHE'
      DataSource = DButton
      DropDownWidth = 250
      Font.Charset = DEFAULT_CHARSET
    ...
    object GroupBox3: TGroupBox
      ...
      ParentFont = False
      TabOrder = 9
      object lblOreMinimePerIndennita: TLabel
        Left = 165
        Top = 23
        Width = 116
        Height = 13
      ...
      object dedtOreMinimePerIndennita: TDBEdit
        Left = 285
        Top = 20
        Width = 58
        Height = 21
        ...
        ParentFont = False
        TabOrder = 1
        OnKeyUp = dedtOreMinimePerIndennitaKeyUp
      end
      object dEdtTariffaIntera: TDBEdit
        Left = 90
        Top = 20
        Width = 58
        Height = 21
      ...
      object optTipoIndennita: TDBRadioGroup
        Left = 354
        Top = 11
        Width = 152
        Height = 32
        ...
        Values.Strings = (
          'O'
          'G')
        OnChange = optTipoIndennitaChange
      end
    end
    object DEdtNMaxRimb: TDBEdit
      Left = 291
      Top = 167
      Width = 47
      Height = 21
    ...
    object DChkTabTariff: TDBCheckBox
      Left = 78
      Top = 86
      Width = 122
      Height = 17
    ...
    object GroupBox4: TGroupBox
      ...
      ParentFont = False
      TabOrder = 8
      object lblGiustifOreMaxGg: TLabel
        Left = 8
        Top = 54
        Width = 90
        Height = 13
      ...
      object dchkGiustifCopreDebitoGg: TDBCheckBox
        Left = 158
        Top = 53
        Width = 135
        Height = 17
      ...
      object dedtGiustifOreMaxGg: TDBEdit
        Left = 104
        Top = 51
        Width = 44
        Height = 21
  ...
  object PclRegole: TPageControl [5]
    Left = 0
    Top = 427
    Width = 532
    Height = 156
    ...
    object TabSheet1: TTabSheet
      Caption = 'Indennit'#224' orarie'
      object LblLimiteOreRetribuiteIntere: TLabel
        Left = 7
        Top = 36
        Width = 117
        Height = 13
      ...
      object lblNMaxGgInteriNelMese: TLabel
        Left = 7
        Top = 60
        Width = 133
        Height = 13
      ...
      object LblPercDiRetrDopoIlSuperoGg: TLabel
        Left = 309
        Top = 60
        Width = 141
        Height = 13
      ...
      object LblPercDiRetrDopoIlSuperOre: TLabel
        Left = 309
        Top = 36
        Width = 144
        Height = 13
      ...
      object LblPercdiRetrRimbPasto: TLabel
        Left = 309
        Top = 12
        Width = 156
        Height = 13
      ...
      object dedtLimiteOreRetribuiteIntere: TDBEdit
        Left = 147
        Top = 33
        Width = 62
        Height = 21
        ...
        DataSource = DButton
        TabOrder = 2
        OnKeyUp = dedtLimiteOreRetribuiteIntereKeyUp
      end
      object dedtPercdiRetrDopoIlSuperoOre: TDBEdit
        Left = 474
        Top = 33
        Width = 43
        Height = 21
      ...
      object dedtNMaxGgRetrInteriNelMese: TDBEdit
        Left = 147
        Top = 57
        Width = 62
        Height = 21
      ...
      object dedtPercdiretrDopoIlSuperoGG: TDBEdit
        Left = 474
        Top = 57
        Width = 43
        Height = 21
      ...
      object dedtPercdiRetrRimbPasto: TDBEdit
        Left = 474
        Top = 9
        Width = 43
        Height = 21
      ...
      object ChkRiduzioneRimbPasto: TDBCheckBox
        Left = 7
        Top = 10
        Width = 202
        Height = 17
        ...
        ValueChecked = 'S'
        ValueUnchecked = 'N'
        OnClick = ChkRiduzioneRimbPastoClick
      end
    end
    object TabSheet2: TTabSheet
      Caption = 'Rimborso pasto'
      ImageIndex = 1
      ...
      object drgrpTipoPasto: TDBRadioGroup
        Left = 0
        Top = -1
        Width = 127
        Height = 104
        ...
        Values.Strings = (
          ...
          '1'
          '2')
        OnChange = drgrpTipoPastoChange
      end
    end
    object TabSheet4: TTabSheet
      Caption = 'Indennit'#224' Km e Rimborsi abilitati'
      ImageIndex = 3
      ...
      object lblRimbKmAutoMinimo: TLabel
        Left = 7
        Top = 109
        Width = 144
        Height = 13
      ...
      object lblRimbKmAutoMinimoKm: TLabel
        Left = 227
        Top = 109
        Width = 14
        Height = 13
      ...
      object BtnIndennita: TButton
        Tag = 1
        Left = 498
        Top = 4
        Width = 22
        Height = 19
        Hint = 'Selezione elementi'
        Caption = '...'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 1
        OnClick = BtnIndennitaClick
      end
      object dEdtRimborsi: TDBEdit
        Left = 80
        Top = 31
        Width = 418
        Height = 21
      ...
      object BtnRimborsi: TButton
        ...
        ShowHint = True
        TabOrder = 3
        OnClick = BtnRimborsiClick
      end
      object dchkRimbKmAuto: TDBCheckBox
        Left = 7
        Top = 59
        Width = 234
        Height = 17
        ...
        ValueChecked = 'S'
        ValueUnchecked = 'N'
        OnClick = dchkRimbKmAutoClick
      end
      object dcmbIndKmAuto: TDBLookupComboBox
        Left = 128
        Top = 80
        Width = 94
        Height = 21
        ...
        ListField = 'CODICE'
        TabOrder = 5
        OnKeyDown = dcmbIndKmAutoKeyDown
      end
      object dedtRimbKmAutoMinimo: TDBEdit
        Left = 172
        Top = 106
        Width = 50
        Height = 21
    ...
    object TabSheet3: TTabSheet
      ...
      object dEdtCodPagheIndIntera: TDBEdit
        Left = 124
        Top = 9
        Width = 62
        Height = 21
      ...
      object dEdtCodPagheSupHH: TDBEdit
        Left = 455
        Top = 9
        Width = 62
        Height = 21
      ...
      object dEdtCodPagheSupGG: TDBEdit
        Left = 124
        Top = 33
        Width = 62
        Height = 21
      ...
      object dEdtCodPagheSupHHGG: TDBEdit
        Left = 455
        Top = 33
        Width = 62
        Height = 21
      ...
      object DRgpDataRif: TDBRadioGroup
        Left = 7
        Top = 58
        Width = 294
        Height = 41
  ...
  object pmnParametri: TPopupMenu
    Left = 498
    Top = 36
  ...
  object PopMenuRimborsi: TPopupMenu
    Left = 350
    Top = 448
