...
type
  ...
  public
    ...
    procedure RiempiSerbatoio(var Serbatoio: TSerbatoi; var Dati: TArrayRiep;CdcTab, CdcCod: String);
...
procedure TR003FGeneratoreStampeMW.RiempiSerbatoio(var Serbatoio : TSerbatoi; var Dati: TArrayRiep; CdcTab,CdcCod: String);
...
begin
  ...
  begin
    ...
    if Pos(Parametri.Applicazione,Serbatoi[i].Applicazione) > 0 then
      RiempiSerbatoio(Serbatoi[i],Dati,CdcTab,CdcCod);
  end;
