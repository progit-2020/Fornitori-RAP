...
type
  ...
  public
    ...
    property EsisteGestioneAlleagati: Boolean read FEsisteGestioneAllegati;
...
const
  ...
  // valori parametri
  // W026: parametro aziendale tipo richiesta
  W026_PAR_TIPORICHIESTA_R = 'R';       // iter in 2 fasi: richiesta + autorizzazione
  W026_PAR_TIPORICHIESTA_A = 'A';       // autorizzazione in un passaggio solo
...
type
  ...
  private
    ...
    FSoloRichiesteConAllegati: Boolean;
  ...
  public
    ...
    // EMPOLI_ASL11 - commessa 2014/054 SVILUPPO#2.fine
    property SoloRichiesteConAllegati: Boolean read FSoloRichiesteConAllegati write FSoloRichiesteConAllegati;
...
begin
  if FSoloRichiesteConAllegati then
  begin
    // filtro per allegati
    Result:='and exists (select ''X'' from dual where T853F_NUMALLEGATI(T850.ID) > 0)';
  end
  else
  begin
    // nessun filtro
