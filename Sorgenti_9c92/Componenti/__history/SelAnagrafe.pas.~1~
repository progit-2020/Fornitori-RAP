...
begin
  ...
  begin
    ...
    if ((C700SelAnagrafe.VariableIndex('C700DATADAL') < 0) and ((DataInizioRap > C700DataLavoro ) or (DataFineRap < C700DataLavoro))) or
       ((C700SelAnagrafe.VariableIndex('C700DATADAL') >= 0) and ((C700DataLavoro < DataInizioRap) or (VarToDateTime(C700SelAnagrafe.GetVariable('C700DATADAL')) > DataFineRap))) then
